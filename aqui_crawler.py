...
def get_aqui_data():
    ...
    for slug in slugs:
        ...
        headers = {
            ...
            "authorization": "bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySUQiOjEsImlhdCI6MTc3MjMzNzg1MiwiZXhwIjoxNzcyOTQyNjUyfQ.v4IRKMSDjnuCPbDYen6vohYQFCf1kZdhxR8sTyH_hlc",
