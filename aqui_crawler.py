...
def get_aqui_data():
    ...
    for slug in slugs:
        ...
        headers = {
            ...
            "authorization": "bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySUQiOjEsImlhdCI6MTc4MTg3NjU2NiwiZXhwIjoxNzgyNDgxMzY2fQ.0fghAMkKXuNPQ0ZpFF6-1GdBtNKPpafNjRlHdirB3bk",
