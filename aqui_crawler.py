...
def get_aqui_data():
    ...
    for slug in slugs:
        ...
        headers = {
            ...
            "authorization": "bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySUQiOjEsImlhdCI6MTc4MjM3NTM0MywiZXhwIjoxNzgyOTgwMTQzfQ.1sWkFSR97Re-s42KIs3T-sEhX_ttvkhhbDPBH0FGQJA",
