...
def get_aqui_data():
    ...
    for slug in slugs:
        ...
        headers = {
            ...
            "authorization": "bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySUQiOjEsImlhdCI6MTc4MzIwOTU0MSwiZXhwIjoxNzgzODE0MzQxfQ.MRiH46lcSGKbuKsi9OEgwPH00tshraplS_mZdufOFE8",
