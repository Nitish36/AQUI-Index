...
def get_aqui_data():
    ...
    for slug in slugs:
        ...
        headers = {
            ...
            "authorization": "bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySUQiOjEsImlhdCI6MTc4NDQyNDY3MCwiZXhwIjoxNzg1MDI5NDcwfQ.H6UHe1wIYBgBLu2j6pmq8_BvtK5yYJQqfnz8joD-ZWM",
