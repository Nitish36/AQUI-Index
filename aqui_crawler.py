...
def get_aqui_data():
    ...
    for slug in slugs:
        ...
        headers = {
            ...
            "authorization": "bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySUQiOjEsImlhdCI6MTc4NTIzNTgxNSwiZXhwIjoxNzg1ODQwNjE1fQ.paUuXLxyiffdjFK0sx9jobXk1oumNlHKOntm1jURdI0",
